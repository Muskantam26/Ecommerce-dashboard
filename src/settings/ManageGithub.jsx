...
const ManageGithub = () => {
  ...
  const [githubData, setGithubData] = useState({
    ...
    callbackUrl: 'https://ecom-demo.workdo.io/greentic/auth/github/callback'
  })
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(githubData.callbackUrl)
  }
  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-2 gap-5 mt-5'>
        <div>
          <h4 className='font-semibold'>Github Client Id</h4>
          <input
            type="password"
            className='input'
            value={githubData.clientId}
        ...
        <div>
          <h4 className='font-semibold'>Github Client Secret</h4>
          <input
            type="password"
            className='input'
            value={githubData.clientSecret}
      ...
      {/* Callback URL */}
      <div className='mt-5'>
        <h4 className='font-semibold'>Github Callback URL</h4>
        <div className='flex gap-2'>
          <input
            type="url"
            className='input'
            value={githubData.callbackUrl}
            readOnly
          />
