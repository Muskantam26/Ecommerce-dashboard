...
const ManageOutlook = () => {
  ...
  const [outlookData, setOutlookData] = useState({
    ...
    callbackUrl: 'https://ecom-demo.workdo.io/greentic/auth/outlook/call-back'
  })
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(outlookData.callbackUrl)
  }
  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-2 gap-5 mt-5'>
        <div>
          <h4 className='font-semibold'>Outlook Client Id</h4>
          <input
            type="password"
            className='input'
            value={outlookData.clientId}
        ...
        <div>
          <h4 className='font-semibold'>Outlook Client Secret</h4>
          <input
            type="password"
            className='input'
            value={outlookData.clientSecret}
      ...
      {/* Callback URL */}
      <div className='mt-5'>
        <h4 className='font-semibold'>Outlook Callback URL</h4>
        <div className='flex gap-2'>
          <input
            type="url"
            className='input'
            value={outlookData.callbackUrl}
            readOnly
          />
