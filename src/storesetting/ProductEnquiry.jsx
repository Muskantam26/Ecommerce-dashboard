      ...
      {Productdata.map(tx => (
        ...
        >
          <p className="text-(--primary)">
            <span className="text-(--text-main)">Product Name:</span> {tx.Product_Name}
          </p>
          <p className="text-(--primary)">
            <span className="text-(--text-main)">Product Query:</span> {tx.Product_Query}
          </p  >
          <p className="text-(--primary)">
            <span className="text-(--text-main)">Product Answer:</span> {tx.Product_Answer}
          </p>
           <p className="text-(--primary)">
